...
var SequelizeField = function () {
  ...
  function SequelizeField(_ref) {
    ...
    this._addHooksTo = function (Model) {
      ...
      _this._BASEPATH = _this._GROUP_BY_ATTRIBUTE ? _this._BASEPATH + "/" + modelFolder : _this._BASEPATH;
    ...
    this._GROUP_BY_ATTRIBUTE = (typeof groupByAttribute === "undefined" ? "undefined" : _typeof(groupByAttribute)) === undefined ? true : groupByAttribute;
  ...
  _createClass(SequelizeField, [{
    ...
    value: function _setFile(instance, options, afterCreate) {
      ...
      if (typeOf(file) === 'Object' && typeof file.mimetype === 'string' && typeof file.path === 'string') {
        ...
        var filename = foldername ? this._BASEPATH + "/" + foldername + ("/" + nameFromUrl(url)) : this._BASEPATH + "/" + nameFromUrl(url);
